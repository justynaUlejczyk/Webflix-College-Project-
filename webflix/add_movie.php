...
# Check for watch link.
  ...
  { $w = mysqli_real_escape_string( $link, trim( $_POST[ 'watch' ] ) ) ; }

  # On success register user inserting into 'movie' database table.
  if ( empty( $errors ) ) 
  {
    $q = "INSERT INTO movie ( movie_title, further_info, img, preview, Genre, Year, Language, Duration, watch) VALUES ( '$mt', '$fi', '$i', '$p', '$g', '$y', '$l', '$d', '$w' )";
...
<form  action="add_movie.php"  method="post" >
  ...
  <input type="text" id="mt" name="movie_title" value="<?php if (isset($_POST['movie_title'])) echo $_POST['movie_title']; ?>" required><br>     
 
  
  <label for="fi">Description:</label><br>
  <input type="text" id="fi" name="further_info" value="<?php if (isset($_POST['further_info'])) echo $_POST['further_info']; ?>" required><br>
...
mysqli_close( $link) ; 
 ...
 <label for="year">Year:</label><br>
  ...
  <input type="text" id="w" name="watch" value="<?php if (isset($_POST['watch'])) echo $_POST['watch']; ?>" required><br>
